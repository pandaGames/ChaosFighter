; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	E:\毕业设计\项目\ChaosFighter\HGEGame\Screen\Mission.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT ??_R2CScreen@@8
; File e:\毕业设计\项目\chaosfighter\hgegame\screen\mission.cpp
rdata$r	SEGMENT
...
??_C@_0BI@JGKBEFBP@Resource?1Font?1font1?4fnt?$AA@ DB 'Resource/Font/font'
	DB	'1.fnt', 00H					; `string'
CONST	ENDS
;	COMDAT __real@431e0000
CONST	SEGMENT
__real@431e0000 DD 0431e0000r			; 158
CONST	ENDS
...
; Line 13
	...
	fstp	DWORD PTR [esp]
	push	ecx
	fld	DWORD PTR __real@43220000
	fstp	DWORD PTR [esp]
	push	ecx
	fld	DWORD PTR __real@431e0000
	fstp	DWORD PTR [esp]
...
; Line 15
	...
	add	esp, 4
	mov	DWORD PTR $T106008[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T106008[ebp], 0
...
$LN4@CMission:
	...
	mov	DWORD PTR $T106007[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T106007[ebp]
	mov	DWORD PTR [edx+16], eax
; Line 16
	push	3112					; 00000c28H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T106012[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	cmp	DWORD PTR $T106012[ebp], 0
	je	SHORT $LN5@CMission
	push	0
	push	OFFSET ??_C@_0BI@JGKBEFBP@Resource?1Font?1font1?4fnt?$AA@
	mov	ecx, DWORD PTR $T106012[ebp]
...
$LN6@CMission:
	...
	mov	DWORD PTR $T106011[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR $T106011[ebp]
...
__unwindfunclet$??0CMission@@QAE@PAVCGame@@@Z$1:
	mov	eax, DWORD PTR $T106008[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$??0CMission@@QAE@PAVCGame@@@Z$2:
	mov	eax, DWORD PTR $T106012[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
...
; Line 21
	...
	mov	DWORD PTR $T106061[ebp], ecx
	mov	edx, DWORD PTR $T106061[ebp]
	mov	DWORD PTR $T106060[ebp], edx
	cmp	DWORD PTR $T106060[ebp], 0
	je	SHORT $LN5@CMission@2
	push	1
	mov	ecx, DWORD PTR $T106060[ebp]
...
; Line 22
	...
	mov	DWORD PTR $T106065[ebp], ecx
	mov	edx, DWORD PTR $T106065[ebp]
	mov	DWORD PTR $T106064[ebp], edx
	cmp	DWORD PTR $T106064[ebp], 0
	je	SHORT $LN7@CMission@2
	push	1
	mov	ecx, DWORD PTR $T106064[ebp]
